...
import rocket from "../assets/second.gif";
...
const CurvedLine = styled.div`
  width: 7rem;
  height: 2rem;
  border: solid 5px #803BEC;
  border-color: #803BEC transparent transparent transparent;
...
with no cost to students.
        <br /> <br />
        We at TECH-TIC-TOE will host a variety of diverse events, ranging from
